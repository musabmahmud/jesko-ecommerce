                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <p class="form-control-static">
                            <input type="text" class="form-control" id="role_name" placeholder="Enter role Name" value="{{$role->name}}" name="role_name">
                        </p>
                        <p>
                            @error('role_name')
                            ...
                            @foreach ($permissions as $permission)
                                <div class="col-md-3">
                                    <div class="checkbox-bird green">
                                        <input type="checkbox" id="{{ $permission->id }}" value="{{ $permission->name }}"  {{ $role->haspermissionto($permission) ? 'checked' : '' }} name="permissions[]">
