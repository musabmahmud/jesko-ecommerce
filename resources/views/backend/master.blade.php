...
<head lang="en">
	...
	<link href="{{ asset('backend')}}/img/favicon.144x144.png" rel="apple-touch-icon" type="image/png" sizes="144x144">
	<link href="{{ asset('backend')}}/img/favicon.114x114.png" rel="apple-touch-icon" type="image/png" sizes="114x114">
	<link href="{{ asset('backend')}}/img/favicon.72x72.png" rel="apple-touch-icon" type="image/png" sizes="72x72">
	<link href="{{ asset('backend')}}/img/favicon.57x57.png" rel="apple-touch-icon" type="image/png">
	<link href="{{ asset('backend')}}/img/favicon.png" rel="icon" type="image/png">
	<link href="{{ asset('backend')}}/img/favicon.ico" rel="shortcut icon">
	...
	<![endif]-->
    <link rel="stylesheet" href="{{ asset('backend')}}/css/lib/lobipanel/lobipanel.min.css">
...
<body class="with-side-menu control-panel control-panel-compact">
	...
	<header class="site-header">
	    <div class="container-fluid">
	        <a href="#" class="site-logo">
	            <img class="hidden-md-down" src="{{ asset('backend')}}/img/logo-2.png" alt="">
	            <img class="hidden-lg-down" src="{{ asset('backend')}}/img/logo-2-mob.png" alt="">
	        </a>
	                ...
	                <div class="site-header-shown">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
	                            ...
	                            <div class="dropdown-menu-notif-list">
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{ asset('backend')}}/img/photo-64-1.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{ asset('backend')}}/img/photo-64-2.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{ asset('backend')}}/img/photo-64-3.jpg" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{ asset('backend')}}/img/photo-64-4.jpg" alt="">
	                                    </div>
	                                ...
	                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
	                                    <div class="dropdown-menu-messages-list">
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{ asset('backend')}}/img/photo-64-2.jpg" alt=""></span>
	                                            <span class="mess-item-name">Tim Collins</span>
	                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
	                                        </a>
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{ asset('backend')}}/img/avatar-2-64.png" alt=""></span>
	                    ...
	                    <div class="dropdown user-menu">
	                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                            <img src="{{ asset('backend')}}/img/avatar-2-64.png" alt="">
	                        </button>
	...
	<script src="{{ asset('backend')}}/js/lib/jquery/jquery-3.2.1.min.js"></script>
	<script src="{{ asset('backend')}}/js/lib/popper/popper.min.js"></script>
