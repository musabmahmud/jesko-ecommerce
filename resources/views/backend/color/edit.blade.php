                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <p class="form-control-static">
                            <input type="text" class="form-control" id="color_name" placeholder="Enter color Name" value="{{$color->color_name}}" name="color_name">
                        </p>
                        <p>
                            @error('color_name')
                    ...
                    <a href="{{route('color.index')}}" class="btn btn-inline btn-primary m-l">Back</a>
