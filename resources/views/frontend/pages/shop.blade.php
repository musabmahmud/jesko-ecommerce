                                        ...
                                        <div class="row mb-n-30px">
                                            ...
                                            <div class="product">
                                                <div class="thumb">
                                                    <a href="{{route('productDetails',$product->product_slug)}}" class="image">
                                                        ...
                                                        <img class="hover-image"
                                                            src="{{asset('products')}}/{{$product->thumbnail}}" alt="{{$product->product_name}}" />
                                                    </a>
                                                    <span class="badges">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="title"><a href="{{route('productDetails',$product->product_slug)}}">{{$product->product_name}}</a>
                                                    </h5>
                                                    <span class="price">
                                                        <span class="new">
                                                            @if (collect($product->attribute)->min('offer_price')< collect($product->attribute)->min('price'))
                                                            <span class="new">${{collect($product->attribute)->min('offer_price')}}</span><span class="old">${{collect($product->attribute)->min('price')}}</span>
                                                            @else
                                                            {{collect($product->attribute)->min('price')}}
                                                            @endif    
                                                        </span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 col-lg-5 col-xl-4">
                                                    <div class="product">
                                                        <div class="thumb">
                                                            <a href="{{route('productDetails',$product->product_slug)}}" class="image">
                                                                <img src="{{asset('products')}}/{{$product->thumbnail}}" alt="{{$product->product_name}}" />
                                                                <img class="hover-image" src="{{asset('products')}}/{{$product->thumbnail}}" alt="{{$product->product_name}}" />
                                                            </a>
                                                            <span class="badges">
                                                                <span class="new">New</span>
                                                            </span>
                            ...
                            <div class="sidebar-widget-category">
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a href="#" class="selected">{{$category->category_name}} <span>({{getCatCount($category->id)}})</span> </a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
