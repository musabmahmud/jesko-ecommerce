                    ...
                    <div class="section-title text-center mb-0">
                        ...
                        <div class="nav-center">
                            <ul class="product-tab-nav nav align-items-center justify-content-center">
                                ...
                                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                        href="#tab-product--new">Default</a>
                            </ul>
                        </div>
                        <!-- Tab End -->
                    </div>
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{$allProduct->product_slug}}">{{$allProduct->product_name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{ asset('products')}}/{{$latest->thumbnail}}" height="300" alt="{{$latest->product_name}}" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{$latest->product_slug}}">{{$latest->product_name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{ asset('products')}}/{{$man->thumbnail}}" height="300" alt="{{$man->product_name}}" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{$man->product_slug}}">{{$man->product_name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{ asset('products')}}/{{$woman->thumbnail}}" height="300" alt="{{$woman->product_name}}" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{$woman->product_slug}}">{{$woman->product_name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{ asset('products')}}/{{$kid->thumbnail}}" height="300" alt="{{$kid->product_name}}" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
                                        ...
                                        <div class="content">
                                            ...
                                            <h5 class="title"><a href="{{$kid->product_slug}}">{{$kid->product_name}}
                                                </a>
                                            </h5>
                                            <span class="price">
                        ...
                        <div class="tab-pane fade show active" id="tab-product-all">
                            <div class="new-product-slider swiper-container slider-nav-style-1 small-nav">
                                <div class="new-product-wrapper swiper-wrapper">
                                    @foreach ($topArrivals as $topArrival)
                                    <div class="new-product-item swiper-slide">
                                        <!-- Single Prodect -->
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('products')}}/{{$topArrival->thumbnail}}" height="300" alt="{{$topArrival->product_name}}" />
                                                </a>
                                                <span class="badges">
                                                    <span class="sale">
                                                        @if (collect($topArrival->attribute)->min('offer_price') < collect($topArrival->attribute)->min('price'))
                                                        -{{100-(collect($topArrival->attribute)->min('offer_price')*100/collect($topArrival->attribute)->min('price'))}}%
                                                        @endif
                                                        </span>
                                                    <span class="new">New</span>
                                                </span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title">
                                                    <a href="{{$topArrival->product_slug}}">{{$topArrival->product_name}}</a>
                                                </h5>
                                                <span class="price">
                                                    @if (collect($topArrival->attribute)->min('offer_price')< collect($topArrival->attribute)->min('price'))
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('products')}}/{{$newProduct->thumbnail}}" height="300" alt="{{$newProduct->product_name}}" />
                                                </a>
                                                <span class="badges">
                                                    <span class="sale">
                                                        @if (collect($newProduct->attribute)->min('offer_price') < collect($newProduct->attribute)->min('price'))
                                                        -{{100-(collect($newProduct->attribute)->min('offer_price')*100/collect($newProduct->attribute)->min('price'))}}%
                                                        @endif
                                                        </span>
                                                    <span class="new">New</span>
                                                </span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a href="{{$newProduct->product_slug}}">{{$newProduct->product_name}}</a>
                                                </h5>
                                                <span class="price">
                                                    @if (collect($newProduct->attribute)->min('offer_price')< collect($newProduct->attribute)->min('price'))
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('products')}}/{{$bestSell->thumbnail}}" height="300" alt="{{$bestSell->product_name}}" />
                                                </a>
                                                <span class="badges">
                                                        @if (collect($bestSell->attribute)->min('offer_price') < collect($bestSell->attribute)->min('price'))
                                                        <span class="sale">-{{100-(collect($bestSell->attribute)->min('offer_price')*100/collect($bestSell->attribute)->min('price'))}}%
                                                        </span>
                                                        @endif
                                                    <span class="new">New</span>
                                                </span>
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title">
                                                    <a href="{{$bestSell->product_slug}}">{{$bestSell->product_name}}</a>
                                                </h5>
                                                <span class="price">
                                                    @if (collect($bestSell->attribute)->min('offer_price')< collect($bestSell->attribute)->min('price'))
